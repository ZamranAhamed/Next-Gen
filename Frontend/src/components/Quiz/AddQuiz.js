...
function AddQuiz() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            console.log("Question added", response.data); // Moved inside the try block

            // Redirect to QuizAdmin.js with a success message
            navigate("/quizadmin", { state: { message: "Quiz was Successfully Created" } });
        } catch (error) {
